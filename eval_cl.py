...
from utils.utils import save_obj, render_color_for_text, compare_text
...
class Evaluation(object):
    ...
    def __init__(self):
        ...
        self.model = DetectionCLModel().eval()
    ...
    def parse_args(self):
        ...
        parser.add_argument('--model-path', type=str, default='./output_cl/csc-best-model.pt',
                            help='The model file path. e.g. "./output/csc-best-model.pt"')
        parser.add_argument('--output-path', type=str, default='./output_cl',
