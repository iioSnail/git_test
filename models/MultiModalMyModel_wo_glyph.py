...
class MyModel(pl.LightningModule):
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.cls = BertOnlyMLMHead(768 + self.pinyin_feature_size, len(self._tokenizer),
                                   layer_num=1)
    ...
    def forward(self, inputs, input_pinyins):
    ...
    def training_step(self, batch, batch_idx, *args, **kwargs):
        inputs, targets, d_targets, loss_targets, input_pinyins = batch
        outputs = self.forward(inputs, input_pinyins)
    ...
    def collate_fn(batch):
        ...
        return src, tgt, (src['input_ids'] != tgt['input_ids']).float(), loss_targets, input_pinyins
