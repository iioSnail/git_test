...
class SoftMaskedBERT(pl.LightningModule):
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("iioSnail\soft-masked-bert-for-csc", trust_remote_code=True)
        self.model = AutoModel.from_pretrained("iioSnail\soft-masked-bert-for-csc", trust_remote_code=True)
