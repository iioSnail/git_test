...
1. 实验结果：P:0.94788, R:0.9422, F1:945。 测试集（Sighan15） P:0.634, R:0.683, f1:0.6575.
1. 实验结果（see=1）: P:0.957, R: 0.9376, F1: 0.947。 测试集（Sighan15）P:0.685, R:0.6785, F1_Score:0.682 
